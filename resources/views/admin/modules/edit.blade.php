...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.modules.update', $module) }}" method="POST" class="glass-card">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="5" 
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $module->description) }}</textarea>
            @error('description')
                <p class="text-red-500 text-sm mt-1"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="number" name="price" id="price" value="{{ old('price', $module->price) }}" min="0" step="100"
